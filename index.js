import {
    ...
    EditOutlined,
    MenuOutlined,
    PlusOutlined, PlusSquareOutlined, TransactionOutlined,
    WarningOutlined
} from '@ant-design/icons';
import { Button, Dropdown, InputNumber, Menu, Modal, notification, Popconfirm, Tooltip } from 'antd';
                            ...
                            <Dropdown
                                overlay={
                                    <Menu>
                                        ...
                                        {(this.props.documentType === constants.SUPPLIER  || this.props.type === constants.ORDER ) && this.props.type !== constants.EXPENSE && (
                                            <Menu.Item
                                                disabled={!this.state.selectedRowKeys.length}
                                                onClick={() => {
                                                    this.setState({});
                        ...
                        <div>
                            ...
                            >
                                <Link to={`${book.order}/${row.orderId || this.props.orderId}`}>
                                    {row.orderNum || this.props.orderNum || `${row.orderId || this.props.orderId ? `${prefix}-${this.props.user.businessId}-` : ''}${row.orderId || this.props.orderId || ''}`}
                                </Link>
                            </div>
                        </div>
                    );
